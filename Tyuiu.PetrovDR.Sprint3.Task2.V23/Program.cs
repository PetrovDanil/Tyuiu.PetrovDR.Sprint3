...
namespace Tyuiu.PetrovDR.Sprint3.Task2.V23
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Написать программу используя цикл do...while, которая вычисляет сумму ряда по формуле, при a=1,5.", width);
            Console.WriteLine(new string('*', width));
